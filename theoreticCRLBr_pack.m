...
for i = 1:length(d)
    ...
    root_CRLB_15kHz_MCS23(i) = sqrt(CalculateCRLBVelocity(15, 1000, d(i)));
    root_CRLB_30kHz_MCS23(i) = sqrt(CalculateCRLBVelocity(30, 1000, d(i)));
    root_CRLB_60kHz_MCS23(i) = sqrt(CalculateCRLBVelocity(60, 1000, d(i)));
end
...
loglog(d, root_CRLB_60kHz_MCS5, 'black-x', 'linewidth',1 , 'MarkerFaceColor', 'black', 'DisplayName', 'PacketSize: 350, SCS: 60 kHz');

loglog(d, root_CRLB_15kHz_MCS23, 'b--o', 'linewidth',1.2 , 'MarkerFaceColor', 'blue', 'DisplayName', 'PacketSize: 1000, SCS: 15 kHz');
loglog(d, root_CRLB_30kHz_MCS23, 'r--s', 'linewidth',1.2 , 'MarkerFaceColor', 'red', 'DisplayName', 'PacketSize: 1000, SCS: 30 kHz');
loglog(d, root_CRLB_60kHz_MCS23, 'black--x', 'linewidth',1 , 'MarkerFaceColor', 'black','DisplayName', 'PacketSize: 1000, SCS: 60 kHz');
